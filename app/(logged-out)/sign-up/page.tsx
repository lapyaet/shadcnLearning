...
const accountTypeList: accoutType[] = [
  {
    name: "Company",
    value: "company",
  },
...
const baseSchema = z.object({
  ...
  }, "You must me at least 18 years old"),
  acceptTerms: z
    .boolean({
      required_error: "You must accept the terms and conditons",
    })
    .refine((checked) => checked, "You must accept the terms and conditons"),
});
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <Select onValueChange={field.onChange}>
                      ...
                      <SelectContent>
                        {accountTypeList.map((data: accoutType) => (
